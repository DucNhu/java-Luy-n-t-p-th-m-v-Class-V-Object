...
public class TestLine {
    public static void main(String[] args) {
        ...
        l1.setEndXY(33, 34);
        System.out.println(l1);
        System.out.println("Begin's and y are: " + Arrays.toString(l1.getBeginXY()));
        System.out.println("End's and y are: " + Arrays.toString(l1.getEndXY()));
